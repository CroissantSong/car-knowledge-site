...
**iBooster 的革命性**：助力大小由软件定义——运动模式下踏板「硬」、舒适模式下踏板「软」。更重要的是，iBooster 能主动建压（不需要人踩），这是 <TermCard term="AEB">AEB</TermCard> 自动紧急制动和自适应巡航主动刹车的基础。
...
- **油电对比**：燃油车用真空助力——依赖发动机，结构简单但不可编程。电动车必须用电助力，反而获得了「线控制动」的能力——<TermCard term="AEB">AEB</TermCard>、<TermCard term="ACC">ACC</TermCard>、单踏板模式都建立在电助力制动可编程的基础上。另外，电动车多了一套再生制动（松油门电机发电回收动能），所以刹车片磨损比燃油车慢很多。
