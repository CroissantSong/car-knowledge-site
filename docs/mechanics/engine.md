...
| 冲程 | 气门状态 | 活塞运动 | 关键动作 |
|------|----------|----------|----------|
| 进气（Intake） | 进气门开，排气门关 | 下行 | 吸入空气 / 混合气 |
| 压缩（Compression） | 进排气门关闭 | 上行 | 混合气被压缩，温度和压力升高 |
| 做功（Power） | 进排气门关闭 | 下行 | 火花塞点火，燃烧推动活塞输出动力 |
| 排气（Exhaust） | 进气门关，排气门开 | 上行 | 排出燃烧废气 |
