...
<figure class="knowledge-figure">
  <img src="/transmission-types.svg" alt="MT AT DCT CVT 四类变速箱结构对比示意图" loading="lazy">
  <figcaption>图：MT、AT、DCT、CVT 用不同结构解决同一个问题：把发动机输出翻译成车轮需要的转速和扭矩。本站自绘 SVG。</figcaption>
</figure>
