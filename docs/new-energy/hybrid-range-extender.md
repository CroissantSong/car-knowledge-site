...
<figure class="knowledge-figure">
  <img src="/hybrid-powertrain-modes.svg" alt="串联混动、并联混动、混联结构和快充 SOC 曲线示意图" loading="lazy">
  <figcaption>图：串联、并联、混联三种混动结构的能量流差异，以及快充功率随 SOC 上升逐步下降的趋势。本站自绘 SVG。</figcaption>
</figure>
