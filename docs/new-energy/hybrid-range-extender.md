...
**原理（说人话）**：混动车有三大流派。串联（增程）最简单——发动机只管发电，不参与驱动，像带了个汽油发电机跑。并联是发动机和电机都能直接驱动车轮，动力猛但控制复杂，市面上已少见。混联（功率分流）是丰田的看家本领——通过一组行星齿轮，让发动机一部分力驱动车轮、一部分力发电，全速域都高效。
